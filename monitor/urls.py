...
urlpatterns = [
    ...
    path('delete-management-destination-Channel/<uuid:rule_id>/<uuid:channel_id>/',DeleteManagementDestinationChannelView.as_view(),name='delete-management-destination-Channel'),
]
